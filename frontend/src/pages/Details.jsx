...
const Details = () => {
  ...
  return (
    <div>
      <Header />
      <section className='bg-[url("http://localhost:5174/src/assets/images/banner/shop.png")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
            ...
            <div>
              <div className="p-5 border">
                <img
                  ...
                  src={
                    image
                      ? `http://localhost:5174/src/assets/images/products/${image}.webp`
                      : `http://localhost:5174/src/assets/images/products/${images[2]}.webp`
                  }
                  alt=""
                />
              </div>
                      ...
                      return (
                        <div key={i} onClick={() => setImage(img)}>
                          <img
                            ...
                            src={`http://localhost:5174/src/assets/images/products/${img}.webp`}
                            alt=""
                          />
                        </div>
                      )
                      ...
                      <Link key={i} className="block">
                        <div className="relative h-[270px]">
                          <img
                            ...
                            src={`http://localhost:5174/src/assets/images/products/${p}.webp`}
                            alt=""
                          />
                          {discount !== 0 && (
