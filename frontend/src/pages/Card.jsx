...
const Card = () => {
  ...
  const inc = (quantity, stock, card_id) => {
    ...
    if (temp <= stock) dispatch(quantityIncrement(card_id))
  }

  const dec = (quantity, card_id) => {
    const temp = quantity - 1

    if (temp !== 0) dispatch(quantityDecrement(card_id))
  }
    ...
    <div>
      ...
      <section className="bg-[#eeeeee]">
        <div className="w-[85%] lg:w-[90%] md:w-[90%] sm:w-[90%] mx-auto py-16">
          {cardProducts.length > 0 || outOfStockProducts > 0 ? (
                          ...
                          <div key={i} className="w-full flex flex-wrap">
                            ...
                            <div className="flex justify-between w-5/12 sm:w-full sm:mt-3">
                              ...
                              <div className="flex gap-2 flex-col">
                                ...
                                <button
                                  onClick={() =>
                                    dispatch(deleteCardProduct(pt._id))
                                  }
                            ...
                            <div key={i} className="w-full flex flex-wrap">
                              ...
                              <div className="flex justify-between w-5/12 sm:w-full sm:mt-3">
                                ...
                                <div className="flex gap-2 flex-col">
                                  ...
                                  <button
                                    onClick={() =>
                                      dispatch(deleteCardProduct(p._id))
                                    }
                                    className="px-5 py-[3px] bg-red-500 text-white"
                                  >
                                    Delete
